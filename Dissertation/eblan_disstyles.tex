...
%\setSpacing{1.42}   % Полуторный интервал, подобный Ворду (нужно включать вместе с предыдущей строкой)
...
%%% "Page" над номерами страниц в оглавлении
\newif\ifendTOC
...
\makeoddfoot{plain}{}{}{}
\pagestyle{plain}
%\thispagestyle{plain} % Если ты хочешь *на всех страницах* такой колонтитул, то лучше добавить
